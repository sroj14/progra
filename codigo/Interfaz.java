...
public class Interfaz extends JFrame{
    ...
    public Interfaz (){
       ...
       /**BOTONES*/
       imagen.setPreferredSize(new Dimension(400,300));
     ...
     btCancelar.addActionListener(new ActionListener(){
       ...
       listBoxBusqueda.addListSelectionListener(new ListSelectionListener() {
        ...
        public void valueChanged(ListSelectionEvent e) {
         ...
         /** Se establece la posicione de los botones, campos de texto, etiquetas,etc.*/ 
       layout.putConstraint(SpringLayout.WEST, imagen, 300, SpringLayout.WEST, contenedor);
